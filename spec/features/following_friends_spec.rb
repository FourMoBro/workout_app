...
RSpec.feature "Following Friends" do
  before do
    @john = User.create(first_name: "John", last_name: "Doe", email: "john@example.com", password: "passowrd")
    @peter = User.create(first_name: "Peter", last_name: "Eater", email: "peter@example.com", password: "passowrd")
